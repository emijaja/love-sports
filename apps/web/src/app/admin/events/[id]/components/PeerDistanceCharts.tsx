...
interface PeerDistanceChartsProps {
  telemetryPeersData: TelemetryPeerData[]
  deviceAssignments: DeviceAssignment[]
}

export default function PeerDistanceCharts({ telemetryPeersData, deviceAssignments }: PeerDistanceChartsProps) {
  ...
  if (pairData.size === 0) {
    return (
      <div className="bg-white shadow-sm rounded-lg p-6">
        <h2 className="text-lg font-medium text-gray-900 mb-4">ピア距離グラフ</h2>
